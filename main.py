...
def chromesend():
    ...
    try:
        ...
        driver.find_element(By.CSS_SELECTOR, "#MenuFramesPageMajor21072 > .pull-left").click()
        driver.find_element(By.ID, "RegistrationAnswerE394dc05b7942a637e052a64670ffd770AnswerValue").click()
        driver.find_element(By.CSS_SELECTOR, ".col-sm-4").click()
        driver.find_element(By.CSS_SELECTOR, ".today").click()
        driver.find_element(By.ID, "RegistrationAnswerBbceb1b7d337c58f2e972fbc908f97310AnswerValue").send_keys(Keys.CONTROL,"a")
        driver.find_element(By.ID, "RegistrationAnswerBbceb1b7d337c58f2e972fbc908f97310AnswerValue").send_keys(Keys.DELETE)
        driver.find_element(By.ID, "RegistrationAnswerBbceb1b7d337c58f2e972fbc908f97310AnswerValue").send_keys(temp)
        driver.find_element(By.ID, "RegistrationAnswer44b3e23a28d39ea0840898d7b7bc8c590AnswerValueC3056ac26d8d0590690d4c81e11dc1f8登校予定").click()
        driver.find_element(By.ID, "RegistrationAnswer44b3e23a28d39ea0840898d7b7bc8c590AnswerValueC3056ac26d8d0590690d4c81e11dc1f8登校予定").click()
